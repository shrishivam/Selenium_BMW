...
public class BMWModule4SellYourCarEmailField {
	...
	@Test
	public void SellYourCarEmailField() throws IOException, InterruptedException {

		ml.clickOnModel();
		ml.clickOnUsedCars();
		ml.clickOnSellYourCar();
		ml.fillSellYourCarName("sellYourCarEmailField.xlsx");
		ml.fillSellYourCarMobileValid("sellYourCarEmailField.xlsx");
		ml.fillSellYourCarEmail("sellYourCarEmailField.xlsx");
