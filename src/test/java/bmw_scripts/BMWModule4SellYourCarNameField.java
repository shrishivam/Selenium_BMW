...
public class BMWModule4SellYourCarNameField {
	...
	@Test
	public void SellYourCarNameField() throws IOException, InterruptedException {

		ml.clickOnModel();
		ml.clickOnUsedCars();
		ml.clickOnSellYourCar();
		ml.fillSellYourCarName("sellYourCarNameField.xlsx");
