...
public class BMWModule4SellYourCarDealerField {
	...
	@Test
	public void SellYourCarDealerField() throws IOException, InterruptedException {
		...
		ml.fillSellYourCarDealer("sellYourCarValidData.xlsx");
		ml.fillSellYourCarSubmit();
		ml.validateSellYourCarDealer();
	}
